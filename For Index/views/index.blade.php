...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Self-TeachLab - Education Responsive HTML5 Template</title>  
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="teachers.html">Live!</a> ></li>
						<li class="nav-item"><a class="nav-link" href="teachers.html">Free Quiz</a></li>
						<li class="nav-item"><a class="nav-link" href="pricing.html">Clasic</a></li>
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Self-TeachLab </strong> E-learning  Platform</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links">
                            <li><a href="https://mail.google.com/">self-teachlab@gmail.com</a></li>
                            <li><a href="#">www.self-teachlab.com</a></li>
                            <li>Bashundhara R/A,Block:C Road No:11 House No:172 Dhaka,Bangladesh</li>
                            <li>+8801722333312</li>
                        </ul><!-- end links -->
                    </div><!-- end clearfix -->
                </div><!-- end col -->
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">                   
                    <p class="footer-company-name">All Rights Reserved. &copy; 2018 <a href="about">Self-TeachLab </a>Design By :<a href ="#">Self-TeamLab Team </a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
